// F-OD-04 — Bayer 16x16 ordered dither.
//
// 256 thresholds, which is as far as the recursion is worth taking: past this
// the tile is finer than the eye resolves and the characteristic cross-hatch
// reads as flat noise, at which point blue noise (F-OD-05) is the better tool.
// It is here because a large tile is what you want when the output is scaled up.
//
