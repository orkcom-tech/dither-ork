// F-OD-02 — Bayer 4x4 ordered dither.
//
// The default ordered dither and the one most people picture when they say
// "Bayer": sixteen thresholds is enough for the pattern to read as a screen
// rather than as noise, and small enough that it stays legible at 1x.
//
