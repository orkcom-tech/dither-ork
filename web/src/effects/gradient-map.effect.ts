...
export const GRADIENT_MAP_PARAMS: readonly ParamDescriptor[] = [
  {
    ...
    type: "float",
    description: "OKLab lightness of the stop the darkest tones map to.",
    animatable: true,
    legal: [0, 1],
    default: 0,
    step: 0.01,
  ...
  },
  {
    ...
    label: "Shadow chroma",
    type: "float",
    description: "OKLab chroma of the shadow stop. 0 is neutral.",
    animatable: true,
    legal: [0, MAX_CHROMA],
    default: 0,
    step: 0.005,
  ...
  },
  {
    ...
    label: "Shadow hue",
    type: "float",
    description: "OKLab hue of the shadow stop, in degrees.",
    animatable: true,
    legal: [0, FULL_TURN],
    default: 0,
    step: 1,
  ...
  },
  {
    ...
    label: "Mid lightness",
    type: "float",
    description: "OKLab lightness of the stop the mid tones map to.",
    animatable: true,
    legal: [0, 1],
    default: 0.5,
    step: 0.01,
  ...
  },
  {
    ...
    label: "Mid chroma",
    type: "float",
    description: "OKLab chroma of the mid stop. This is where a duotone gets its colour.",
    animatable: true,
    legal: [0, MAX_CHROMA],
    default: 0,
    step: 0.005,
  ...
  },
  {
    ...
    label: "Mid hue",
    type: "float",
    description: "OKLab hue of the mid stop, in degrees.",
    animatable: true,
    legal: [0, FULL_TURN],
    default: 0,
    step: 1,
  ...
  },
  {
    ...
    type: "float",
    description: "OKLab lightness of the stop the brightest tones map to.",
    animatable: true,
    legal: [0, 1],
    default: 1,
    step: 0.01,
  ...
  },
  {
    ...
    type: "float",
    description: "OKLab chroma of the highlight stop. 0 is neutral.",
    animatable: true,
    legal: [0, MAX_CHROMA],
    default: 0,
    step: 0.005,
  ...
  },
  {
    ...
    label: "Highlight hue",
    type: "float",
    description: "OKLab hue of the highlight stop, in degrees.",
    animatable: true,
    legal: [0, FULL_TURN],
    default: 0,
    step: 1,
  ...
  },
  {
    ...
    label: "Mid position",
    type: "float",
    description: "Where along the tonal range the mid stop sits.",
    animatable: true,
  ...
  },
  {
    ...
    label: "Amount",
    type: "float",
    description: "Blend between the source colours and the mapped ramp.",
    animatable: true,
    legal: [0, 1],
    default: 1,
    step: 0.01,
...
export default defineEffect({
  ...
  name: "Gradient map",
  summary:
    "Maps the picture's tone onto a three-stop colour ramp — the duotone control.",
  description:
    "Every pixel's brightness picks a colour from a ramp with a shadow, a mid and a highlight stop, so the original colours are discarded and replaced by the ramp. This is how duotones and split tones are made, and it pairs directly with a dither: map to two strong colours, then dither, and the whole picture is built out of that pair. Each stop is given as OKLab lightness, chroma and hue rather than as a swatch, because a colour cannot cross the parameter channel to a shader as a triplet; mid chroma is where a duotone gets its colour.",
  keywords: ["gradient map", "duotone", "tritone", "split tone", "colorize", "colourize", "ramp", "palette map", "tint", "two colour", "two color", "recolour", "recolor"],
